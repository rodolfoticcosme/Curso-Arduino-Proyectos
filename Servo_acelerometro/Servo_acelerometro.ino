...
#define MPU 0x68 // asegurarse que esta direccion I2C de la IMU
...
/*
  ...
  delay(10); //Nuestra dt sera, pues, 0.010, que es el intervalo de tiempo en cada lectura (es una aproximacion seria el tiempo de loop)
  */
}
